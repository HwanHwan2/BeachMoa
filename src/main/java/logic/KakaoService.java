...
public class KakaoService {
	...
	public JsonNode getAccessToken(String authorize_code) {
		...
		postParams.add(new BasicNameValuePair("client_id", "a5e07eaae67f31a7600a4ba004d7bf55")); // REST API KEY
		postParams.add(new BasicNameValuePair("redirect_uri", "http://localhost:8080/BeachMoa/user/kakaologin.do")); // URI
