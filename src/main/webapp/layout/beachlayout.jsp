    ...
    <c:choose>
       ...
       <div class = "w3-cell">
    		<div class = "w3-cell dropdown">
    			...
    			<div class="dropdown-menu pull-right" role="menu" aria-labelledby="dropdownMenu1" id = "alarmCard" style = "width:300px; height:auto; position:absolute; padding:16px 0 20px;">
		...
		success : function(data) {
			if(data != null) {
				...
				$.each(JSON.parse(values), function(index, value) {
					let html = "<a href = " + value.a_href + " style = 'margin:8px 8px 8px 8px;'>";
					   ...
					   html += "	</li>";
					   html += "</a>";
					$("#alarmCard").append(html);
				})
			} else {
				$("#alarmCard").append("알림이 없습니다.");
			}
		},
		error : function(data) {
